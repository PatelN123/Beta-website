    ...
    <Box as='section' overflow='hidden' mb={12}>
      <Container py='7.5rem' maxW='1280px'>
        <Box maxW='760px' mx='auto' textAlign='center'>
          <chakra.h3 textStyle='heading' mb={4}>
            {t('homepage.built-with-chakra-section.title')}
          </chakra.h3>
          <chakra.p opacity={0.7} fontSize='lg' mb={8}>
          Our gift boxes are the perfect gift for any occasion. You can mix up the contents by contacting us with your requirements.
